...
public class MoveStep implements Serializable {
    ...
    public void setVTOLBombing(boolean bombing) {
        if (bombing) {
            setTarget(new HexTarget(getPosition(), entity.getCurrentBoard(), Targetable.TYPE_HEX_AERO_BOMB));
        } else {
            setTarget(null);
        }
    }
    ...
    public void setStrafing(boolean strafing) {
        if (strafing) {
            setTarget(new HexTarget(getPosition(), entity.getCurrentBoard(), Targetable.TYPE_HEX_CLEAR));
        } else {
            setTarget(null);
        }
    }
